-- Упрощенная настройка Supabase без RLS (для быстрого запуска)
...
-- Даем доступ к таблицам для anon роли
GRANT ALL ON conversations TO anon;
GRANT ALL ON knowledge_base TO anon;
GRANT ALL ON user_profiles TO anon;
GRANT ALL ON SEQUENCE conversations_id_seq TO anon;
GRANT ALL ON SEQUENCE knowledge_base_id_seq TO anon;

-- Вывод информации о созданных объектах
SELECT 'Упрощенная векторная база данных настроена успешно!' AS status;
...
SELECT 'RLS отключен для простоты настройки' AS security_note;