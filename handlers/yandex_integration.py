...
def create_calendar_setup_menu():
    ...
    builder.add(
        ...
        InlineKeyboardButton(text="📘 Подробная инструкция", url="https://teletype.in/@asterioai/yandex-calendar"),
...
async def calendar_setup_help(callback: CallbackQuery):
    ...
    help_keyboard.add(
        InlineKeyboardButton(text="📘 Подробная инструкция с картинками", url="https://teletype.in/@asterioai/yandex-calendar"),
